...
- El socio podra reservar gratuitamente la entrada a las salas generales (musculación, bicicletas, etc.).
...
### Elegir tipo de plan
- Podrá elegir entre distintos tipos de tarifa para el acceso ilimitado a clases o actividades. Dependiendo de la tarifa, podrás acceder a más o menos axctividades gratis.
